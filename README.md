...
Job board splits blanks into **Blanks Ordered** (`blanks`) and **Blanks in Stock** (`blanks_stock`) after Approved. Pipeline: Quote → Approved → Blanks Ordered → Blanks in Stock → In production → Ready → Delivered.
